<?php
$pagina_link = 'fornecedores_inativos';
include_once("../core/mod_includes/php/connect.php");
include_once("../core/mod_includes/php/funcoes.php");
session_start();
$page = "<a href='fornecedores_inativos/view'>Fornecedores Não Certificados</a>";
    ...
    <main class="cd-main-content">
        <div class="container">
            ...
            <div class="wrapper">
                ...
                $fa_status_crc              = $_POST['fa_status_crc'];
                            ...
                            if($stmt_atributos->execute($dados_atributos)){
                                ...
                                ?>
                                    <script>
                                        ...
                                        function sucess(id){window.location.replace('fornecedores_inativos/edit/'+id)};
                                    </script>
                                <?php
                ...
                $sql = "SELECT * FROM fornecedores       
                            ...
                            WHERE " . $nome_query . " AND licitacao_documentacao.ldc_id is null 
                ...
                if ($pagina == "view") {
                    echo "
                        ...
                        <div id='botoes'>
                            <div class='filtro2'>
                            <div class='g_adicionar' title='Adicionar' onclick='verificaPermissao(" . $permissoes["add"] . ",\"fornecedores_inativos/add\");'><i class='fas fa-plus'></i></div>

                                <form name='form_filtro' id='form_filtro' enctype='multipart/form-data' method='post' action='fornecedores_inativos/view'>
                                                ...
                                                <td align=center>
                                                    <div class='g_excluir' onclick=\"
                                                            abreMask(
                                                                ...
                                                                '<input value=\' Sim \' type=\'button\' class=\'close_janela\' onclick=verificaPermissao(" . $permissoes["excluir"] . ",\'fornecedores_inativos/view/excluir/$id\');>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+
                                                                '<input value=\' Não \' type=\'button\' class=\'close_janela\'>');
                                                            \">	<i class='far fa-trash-alt'></i>
                                                    </div>
                                                    <div class='g_editar'  title='Editar' onclick='verificaPermissao(" . $permissoes["edit"] . ",\"fornecedores_inativos/edit/$id\");'><i class='fas fa-pencil-alt'></i></div>											
                                                </td>
                                            </tr>";
                        }
                        echo "</table>";
                ...
                if ($pagina == 'add') {
                    echo "	
                        <form name='form' id='form' enctype='multipart/form-data' method='post' action='fornecedores_inativos/view/adicionar'>
                    ...
                    echo "</select> 
                                    <p><label>Status:</label> <input type='radio' name='exibir' value='1' checked> Ativo &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <input type='submit' id='bt_fornecedores_inativos' value='Salvar' />&nbsp;&nbsp;&nbsp;&nbsp; 
                                <input type='button' id='botao_cancelar' onclick=javascript:window.location.href='fornecedores_inativos/view'; value='Cancelar'/></center>
                                </center>
                            </div>
                        </form>
                        ";
                ...
                if ($pagina == 'edit') {
                    ...
                    if ($rows > 0) {
                        $result = $stmt->fetch();
                           echo "
                            <form name='form' id='form' enctype='multipart/form-data' method='post' action='fornecedores_inativos/view/editar/$id'>
                                ...
                                <div class='comp_end'>
                                    ...
                                    echo "</select>
                                        ...
                                        <div id='informacoes' class='tab-pane fade in'>
                                            ...
                                            <p><label>Emissão do CRC:</label> <input type='text' name='data_emissao_crc' id='data_emissao_crc'  value='".date("d/m/Y", strtotime($result['fa_emissao_crc']))."'>
                                            <p><label>Tipo fornecedor:</label> <select name='fa_tipo_fornecedor' id='fa_tipo_fornecedor'>";
...
<script>
    ...
    function editar(id){
        location.replace("fornecedores_inativos/edit/"+id); 
    }
