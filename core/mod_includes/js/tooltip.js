...
//----------------------------------------------------------------------------------------------------
	...
	this.textFont = "Open Sans";	// text font family
	...
	this.border = "1px dashed #AAA";	// border (CSS spec: size style color, e.g. "1px solid #D00000")
	this.padding = 10;					// padding (pixels)
...
//----------------------------------------------------------------------------------------------------
	this.create = function() {
		...
		if(this.radius) this.obj.style.WebkitBorderRadius = this.radius + 'px';
		if(this.radius2) this.obj.style.borderRadius = this.radius2 + 'px';
		if(this.radius3) this.obj.style.MozBorderRadius = this.radius3 + 'px';
		if(this.transitions) this.obj.style.webkitTransitionDuration = this.transitions + 's';
	...
	this.init = function() {
		...
		this.obj.id = 'ToolTip';
		this.obj.style.radius = '-webkit-border-radius';
		this.obj.style.radius2 = 'border-radius';
		...
		/*this.obj.style.transitions = '-webkit-transition-duration';
		this.obj.style.transitions2 = '-moz-transition-duration';
		this.obj.style.transitions3 = 'transition-duration';*/
		this.obj.onmouseover = function() { tooltip.show("slow"); }
		this.obj.onmouseout = function() { tooltip.hide(500); }
		this.obj.onclick = function() { tooltip.hide(500); }
